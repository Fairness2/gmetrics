...
// Source: internal/store/skill/store.go
...
import (
	context "context"
	skill "gmetrics/internal/store/skill"
	reflect "reflect"
...
func (m *MockStore) GetMessage(ctx context.Context, id int64) (*skill.Message, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetMessage", ctx, id)
	ret0, _ := ret[0].(*skill.Message)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) ListMessages(ctx context.Context, userID string) ([]skill.Message, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) SaveMessage(ctx context.Context, userID string, msg skill.Message) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) SaveMessages(ctx context.Context, messages ...skill.Message) error {
	m.ctrl.T.Helper()
